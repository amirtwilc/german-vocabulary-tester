...
export interface Noun {
  ...
  german: string;
  english: string;
  /** Omit for nouns without a plural in the recorded meaning. */
  plural?: string;
  article: Article;
}
...
export const vocabulary = {
  nouns: [
    ...
    { id: 'pech', german: 'Pech', english: 'bad luck', article: 'das' },
    {
      id: 'laune',
      german: 'Laune',
      english: 'mood',
    ...
    { id: 'verkehr', german: 'Verkehr', english: 'traffic', article: 'der' },
    {
      id: 'waehrung',
      german: 'Währung',
      english: 'currency',
    ...
    },
    {
      id: 'unterlage',
      german: 'Unterlage',
      english: 'document / supporting material',
      plural: 'Unterlagen',
      article: 'die',
    },
    {
  ...
  verbs: [
    ...
    },
    {
      ...
      auxiliary: 'hat',
      notes: 'Often used with auf + Akkusativ.',
    },
    {
      id: 'teilen',
      infinitive: 'teilen',
      ...
      pastParticiple: 'geteilt',
      auxiliary: 'hat',
      case: 'Akkusativ',
      notes: 'sich teilen means to split or divide into parts.',
    },
    {
      id: 'ausprobieren',
      ...
      present: {
        ich: 'probiere aus',
        du: 'probierst aus',
        erSieEs: 'probiert aus',
        ihr: 'probiert aus',
      },
      pastParticiple: 'ausprobiert',
      auxiliary: 'hat',
      case: 'Akkusativ',
    },
    {
      ...
      auxiliary: 'hat',
      case: 'Akkusativ + Dativ',
      notes: 'sich bieten means to present itself, as with an opportunity.',
    },
    {
      id: 'kritisieren',
    ...
    },
    {
      ...
      pastParticiple: 'geachtet',
      auxiliary: 'hat',
      case: 'Akkusativ',
      notes: 'achten auf + Akkusativ means to pay attention to something.',
    },
    {
      id: 'ausdruecken',
      ...
      pastParticiple: 'ausgedrückt',
      auxiliary: 'hat',
      case: 'Akkusativ',
      notes: 'sich ausdrücken means to express oneself.',
    },
    {
      id: 'bedauern',
      infinitive: 'bedauern',
    ...
    },
    {
      ...
      pastParticiple: 'beruhigt',
      auxiliary: 'hat',
      case: 'Akkusativ',
      notes: 'sich beruhigen means to calm down.',
    },
    {
      id: 'unterrichten',
      ...
      present: {
        ich: 'unterrichte',
        du: 'unterrichtest',
        erSieEs: 'unterrichtet',
        ihr: 'unterrichtet',
      },
      pastParticiple: 'unterrichtet',
      auxiliary: 'hat',
      case: 'Akkusativ',
      notes: 'sich über etwas unterrichten means to inform oneself.',
    },
    {
      id: 'mitmachen',
    ...
    },
    {
      ...
      auxiliary: 'hat',
      notes: 'eine Prüfung bestehen takes Akkusativ; bestehen aus takes Dativ.',
    },
    {
      id: 'austauschen',
      ...
      pastParticiple: 'ausgetauscht',
      auxiliary: 'hat',
      case: 'Akkusativ',
      notes: 'sich mit jemandem austauschen means to exchange views.',
    },
    {
      id: 'erleben',
      infinitive: 'erleben',
    ...
    },
    {
      ...
      auxiliary: 'hat',
      case: 'Akkusativ',
      notes: 'sich verlängern means to become longer or be extended.',
    },
    {
      id: 'beantragen',
    ...
    },
    {
      ...
      pastParticiple: 'gesperrt',
      auxiliary: 'hat',
      case: 'Akkusativ',
      notes: 'sich gegen etwas sperren means to resist or refuse it.',
    },
    {
      id: 'bereuen',
      infinitive: 'bereuen',
    ...
    },
    {
      ...
      auxiliary: 'hat',
      case: 'Akkusativ',
      notes: 'sich an etwas stören means to be bothered by it.',
    },
    {
      id: 'hinterlassen',
    ...
    },
    {
      ...
      pastParticiple: 'ausgerichtet',
      auxiliary: 'hat',
      case: 'Akkusativ + Dativ',
      notes:
        'sich nach etwas ausrichten means to align or orient oneself by it.',
    },
  ],
  ...
  adjectivesAndAdverbs: [
    ...
    { id: 'genug', kind: 'adverb', german: 'genug', english: 'enough' },
    {
      id: 'zufrieden',
      kind: 'adjective',
      german: 'zufrieden',
    ...
    },
    {
      ...
      comparative: 'stiller',
      superlative: 'am stillsten',
    },
    { id: 'tot', kind: 'adjective', german: 'tot', english: 'dead' },
    {
      id: 'zuletzt',
      kind: 'adverb',
      german: 'zuletzt',
      english: 'last / most recently',
    },
    {
      id: 'taetig',
      kind: 'adjective',
    ...
    },
    {
      ...
      comparative: 'bequemer',
      superlative: 'am bequemsten',
    },
    {
      id: 'haeufig',
      kind: 'adjective',
    ...
    { id: 'verloren', kind: 'adjective', german: 'verloren', english: 'lost' },
    {
      id: 'sauber',
      kind: 'adjective',
      german: 'sauber',
    ...
    },
    {
      ...
      comparative: 'riesiger',
      superlative: 'am riesigsten',
    },
    {
      id: 'ungefaehr',
      kind: 'adverb',
    ...
    },
    {
      ...
      german: 'aufregend',
      english: 'exciting',
      comparative: 'aufregender',
      superlative: 'am aufregendsten',
    },
    {
      id: 'dabei',
      kind: 'adverb',
      german: 'dabei',
      english: 'there / along with it',
    },
    { id: 'manche', kind: 'adjective', german: 'manche', english: 'some' },
    { id: 'nirgends', kind: 'adverb', german: 'nirgends', english: 'nowhere' },
    {
      id: 'fremd',
      kind: 'adjective',
      german: 'fremd',
      english: 'foreign / unfamiliar',
      comparative: 'fremder',
      superlative: 'am fremdesten',
    },
    { id: 'wohl', kind: 'adverb', german: 'wohl', english: 'probably / well' },
    {
      id: 'schlimm',
      kind: 'adjective',
      german: 'schlimm',
    ...
    },
    {
      ...
      kind: 'adjective',
      german: 'unordentlich',
      english: 'untidy / messy',
      comparative: 'unordentlicher',
      superlative: 'am unordentlichsten',
    },
    {
      id: 'verspaetet',
      kind: 'adjective',
    ...
    },
    {
      ...
      english: 'next to each other / side by side',
    },
    {
      id: 'preiswert',
      kind: 'adjective',
      german: 'preiswert',
      english: 'inexpensive / good value',
      comparative: 'preiswerter',
      superlative: 'am preiswertesten',
    },
    {
      id: 'erreichbar',
      kind: 'adjective',
      ...
      comparative: 'erreichbarer',
      superlative: 'am erreichbarsten',
    },
    {
      id: 'befristet',
      kind: 'adjective',
    ...
    },
    {
      ...
      german: 'unnötig',
      english: 'unnecessary',
      comparative: 'unnötiger',
      superlative: 'am unnötigsten',
    },
    {
      id: 'einige',
      kind: 'adjective',
